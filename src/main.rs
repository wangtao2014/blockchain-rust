...
fn main() {
    let mut miner_adder = String::new();
    ...
    io::stdin().read_line(&mut miner_adder).unwrap();
    print!("Difficulty: ");
    io::stdout().flush().unwrap();
    ...
    let mut chain = blockchain::Chain::new(miner_adder.trim().to_string(), diff);
    ...
    loop {
        ...
        match choice.trim().parse().unwrap() {
            ...
            2 => {
                ...
                match res {
                    true => println!("Generating block succeeded"),
                    false => println!("Generating block failed"),
                }
            }
            3 => {
                ...
                match res {
                    true => println!("Update difficulty succeeded"),
            ...
            4 => {
                ...
                match res {
                    true => println!("Update reward succeeded"),
